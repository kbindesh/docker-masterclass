...
## 01. Creating and mounting data volumes

### Step-1.1: Modifying the container layer and check the difference
...
### Step-1.2: Create a Volume | List | Inspect
...
### Step-1.3: Mounting a volume on Container
...
### Step-1.4: Delete the Container with Volume mounted on it
...
### Step-1.5: Create a new Container and mount the Volume created in Step#1 on it
...
### Step-1.7: `Sharing Data` between containers `using Docker Volumes`
...
### Step-1.8: Using Host volumes

### Step-1.9: Defining Volumes in Docker Image
